...
def main():
    ...
    pickle.dump(trainX_rescale, open(f'../postprocess/x_train_rescale_{args.n_steps}_lag_{args.lead_time}_lead.pkl', 'wb'))
    pickle.dump(trainY_rescale, open(f'../postprocess/y_train_rescale_{args.n_steps}_lag_{args.lead_time}_lead.pkl', 'wb'))
    pickle.dump(testX_rescale, open(f'../postprocess/x_test_rescale_{args.n_steps}_lag_{args.lead_time}_lead.pkl', 'wb'))
    pickle.dump(testY_rescale, open(f'../postprocess/y_test_rescale_{args.n_steps}_lag_{args.lead_time}_lead.pkl', 'wb'))
    pickle.dump(testY, open(f'../postprocess/y_test_{args.n_steps}_lag_{args.lead_time}_lead.pkl', 'wb'))
