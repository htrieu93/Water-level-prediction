...
if __name__ == '__main__':
    ...
    trainX_rescale, trainY_rescale = split_data_by_year(trainX, trainY, args.n_steps, args.lead_time, args.scenario,
                                                        train_year_len)
    ...
    testX_rescale, testY_rescale = split_data_by_year(testX, testY, args.n_steps, args.lead_time, args.scenario,
                                                      test_year_len)
    ...
    pickle.dump(trainX_rescale,
                open(f'../postprocess/x_train_rescale_s{args.scenario}_{args.n_steps}_lag_{args.lead_time}_lead.pkl',
                     'wb'))
    pickle.dump(trainY_rescale,
                open(f'../postprocess/y_train_rescale_s{args.scenario}_lag_{args.lead_time}_lead.pkl', 'wb'))
    pickle.dump(testX_rescale,
                open(f'../postprocess/x_test_rescale_s{args.scenario}_lag_{args.lead_time}_lead.pkl', 'wb'))
    pickle.dump(testY_rescale,
                open(f'../postprocess/y_test_rescale_s{args.scenario}_lag_{args.lead_time}_lead.pkl', 'wb'))
    pickle.dump(testY,
                open(f'../postprocess/y_test_s{args.scenario}_{args.n_steps}_lag_{args.lead_time}_lead.pkl', 'wb'))
