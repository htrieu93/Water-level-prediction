...
# Read 2016 data
MN_data_2016_1 = pd.read_excel('/content/drive/MyDrive/Water level prediction paper/Model Thầy Chiểu/data/)XHh_Nhatle_2016.xlsx', 
                               sheet_name='H_KG_DH', skiprows=2, 
                               names=['Time', 'H_KienGiang', 'H_DongHoi'])

MN_data_2016_2 = pd.read_excel('/content/drive/MyDrive/Water level prediction paper/Model Thầy Chiểu/data/)XHh_Nhatle_2016.xlsx', 
                               sheet_name='Hh_LeThuy_Oct', skiprows=2, usecols='A,F',
                               names=['Time', 'H_LeThuy'])

LM_data_2016 = pd.read_excel('/content/drive/MyDrive/Water level prediction paper/Model Thầy Chiểu/data/)XHh_Nhatle_2016.xlsx', 
                             sheet_name='Xh_Donghoi_Sep2Nov', skiprows=2, usecols='G,H,I',
                             names=['Date', 'Time', 'LM_DongHoi'])

# Read 2020 data
MN_data_2020 = pd.read_excel('/content/drive/MyDrive/Water level prediction paper/Model Thầy Chiểu/data/XQHh_Nhatle_2020.xlsx', 
                             sheet_name='QHh_2020', skiprows=2, 
                             names=['Time', 'Q_KienGiang', 'H_KienGiang', 'H_LeThuy', 'H_DongHoi'])

LM_data_2020 = pd.read_excel('/content/drive/MyDrive/Water level prediction paper/Model Thầy Chiểu/data/XQHh_Nhatle_2020.xlsx', 
...
dataset_a = pd.concat([data_2010_a, data_2012_a, data_2016_a, data_2020_a])
...
dataset_b = pd.concat([data_2012_b, data_2020_b])
...
data_2020_c = data_2020[['H_LeThuy', 'H_KienGiang', 'H_DongHoi', 'H_LeThuy', 'LM_KienGiang', 'LM_LeThuy', 'LM_DongHoi',
                         'LM_LeThuy_lead1', 'LM_KienGiang_lead1', 'LM_DongHoi_lead1']].astype(np.float32)
dataset_c = pd.concat([data_2012_c, data_2020_c])
